        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form method="POST" action="<?php echo e(route('orders.delete', $orden->id)); ?>" enctype="multipart/form-data" novalidate>
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" id="subtotal" name="subtotal" value="<?php echo e($orden->subtotal); ?>"
                            class="mt-1 p-2 block w-full border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" readonly>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\clientedemo\resources\views//admin/orden/show.blade.php ENDPATH**/ ?>